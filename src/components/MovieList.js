            ...
            <div className="row">
                <div className="col-lg-4">
                    <div className="card mb-4 shadow-sm">
                        <img src="https://image.tmdb.org/t/p/w220_and_h330_face/wHa6KOJAoNTFLFtp7wguUJKSnju.jpg" className="card-img-top" alt="" />
                        <div className="card-body">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <h2><span className="badge bg-secondary">9.0</span></h2>
                            </div>
                        </div>
                    </div>
                </div>
